...
export default function Home() {
  ...
  <div className="flex md:order-2">
      <button type="button" className="text-white bg-brown hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-brown dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      ...
      <div>
        <center>
        <h1 className="mt-20 mr-20 ml-20 mb-20 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">The hunt is on! <span className="text-red-600 dark:text-red-500"> Unravel the mystery </span> and claim your reward</h1>
        <Link href="/game">
